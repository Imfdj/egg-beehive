...
class RoleController extends Controller {
  ...
  async findAll() {
    ...
    const params = {
      name: {
        ...ctx.rule.project_template_taskBodyReq.name,
        required: false,
      },
      project_template_id: {
        ...ctx.rule.project_template_taskBodyReq.project_template_id,
        required: false,
      },
      prop_order: {
        type: 'enum',
        required: false,
        values: [...Object.keys(ctx.rule.project_template_taskPutBodyReq), ''],
      },
      order: {
        type: 'enum',
        required: false,
    ...
    const res = await service.projectTemplateTasks.findAll(ctx.query);
