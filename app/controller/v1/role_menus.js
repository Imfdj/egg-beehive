...
class RoleController extends Controller {
  ...
  async findAll() {
    ...
    const params = {
      role_id: {
        ...ctx.rule.role_menuBodyReq.role_id,
        required: false,
      },
      menu_id: {
        ...ctx.rule.role_menuBodyReq.menu_id,
        required: false,
      },
      prop_order: {
        type: 'enum',
        required: false,
        values: [...Object.keys(ctx.rule.role_menuPutBodyReq), ''],
      },
      order: {
        type: 'enum',
        required: false,
    ...
    const res = await service.roleMenus.findAll(ctx.query);
