  ...
  describe('GET /api/v1/role_permissions/list', () => {
    it('should work', async () => {
      ...
      const res = await app.httpRequest()
        ...
        .query({ limit: 1000, permission_id: permissionResRows[ 0 ].id, role_id: roleResRows[ 0 ].id })
        .set('authorization', app.__authorization);
      ...
      const res2 = await app.httpRequest()
        .get('/api/v1/role_permissions/list')
        .query({ limit: 1000, permission_id: permissionResRows[ 1 ].id, role_id: roleResRows[ 0 ].id })
        .set('authorization', app.__authorization);
